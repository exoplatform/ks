 ...
 * Aug 08, 2012  
 */
public class WikiPagePermissionPlugin extends UpgradeProductPlugin {
  private static final Log LOG = ExoLogger.getLogger(WikiPagePermissionPlugin.class);

  public WikiPagePermissionPlugin(InitParams initParams) {
    super(initParams);
  }
  ...
  private void fixPermissionOfWikiPages() {
    ...
    while (pageIterator.hasNext()) {
      ...
      try{
	      ...
	      LOG.info("\nNew permssion for {}/{}\n", page.getName(), page.getPermission());
        checkedPage++;
